...
export default function Footer() {
 ...
 <a href="https://github.com/abhishekh-developer" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
 <FaGithub size={18} />
 </a>
 ...
 <a href="mailto:abhishekh@example.com" className="hover:text-white transition-colors">
 <Mail size={18} />
 </a>
 </div>
 ...
 Built with <span className="text-purple-400">React 19</span>, <span className="text-cyan-400">Tailwind CSS</span>, <span className="text-emerald-400">Node.js</span>, & <span className="text-white">MongoDB</span>.
 </div>
 <div className="text-[10px] sm:text-xs text-zinc-500 font-body text-center sm:text-right">
 &copy; {new Date().getFullYear()} Abhishekh Kumar. All rights reserved.
 </div>
