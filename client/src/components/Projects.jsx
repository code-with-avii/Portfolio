...
import { ExternalLink, BookOpen, Search, Filter, FolderGit } from 'lucide-react';
...
const filterTags = ['All', 'React', 'Next.js', 'Node.js', 'Express', 'MongoDB', 'TypeScript', 'Redis'];
...
export default function Projects() {
 ...
 {/* Background blurs */}
 <div className="absolute bottom-1/3 left-0 w-[350px] h-[350px] rounded-full bg-primary/5 blur-[120px] pointer-events-none" />
 ...
 >
 Explore interactive software applications showcasing full-stack logic, system integrations, and elegant UI styles.
 </motion.p>
 </div>
 ...
 No projects found matching the criteria. Try adjusting your query or filters.
 </div>
 )}
