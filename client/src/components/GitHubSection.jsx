...
const pinnedRepos = [
 {
 name: 'ai-marketplace',
 description: 'A premium SaaS Prompt Marketplace platform with credit transactions, OpenAI previews playground, and fine-tuned model sharing.',
 language: 'TypeScript',
...
export default function GitHubSection() {
 ...
 <div className="absolute top-1/2 left-1/2 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[140px] pointer-events-none -translate-x-1/2 -translate-y-1/2" />
 ...
 >
 Check out real-time commits logging and pinned codes stored in my public space.
 </motion.p>
 </div>
 ...
 <FaGithub size={15} /> @abhishekh-developer contributions in the last year
 </h3>
 
 <div className="overflow-x-auto no-scrollbar pb-2">
 <div className="flex gap-[3px] w-[650px] flex-wrap h-[90px] overflow-hidden select-none">
 {contributionDots.map((dot) => (
 <div
 key={dot.id}
 className={`w-[10px] h-[10px] rounded-[2px] ${dot.color} transition-all hover:scale-125 cursor-pointer`}
 ...
 <span>Less</span>
 <div className="w-[10px] h-[10px] rounded-[2px] bg-zinc-900" />
 <div className="w-[10px] h-[10px] rounded-[2px] bg-purple-900" />
 <div className="w-[10px] h-[10px] rounded-[2px] bg-purple-700" />
 <div className="w-[10px] h-[10px] rounded-[2px] bg-cyan-500" />
 <div className="w-[10px] h-[10px] rounded-[2px] bg-cyan-400" />
 <span>More</span>
 </div>
 <span>Dec 2025</span>
 </div>
 ...
 <span className={`w-2.5 h-2.5 rounded-full ${repo.langColor} mr-1`} />
 {repo.language}
 </div>
 <div className="flex items-center gap-3">
 <span className="flex items-center gap-0.5"><Star size={12} /> {repo.stars}</span>
 <span className="flex items-center gap-0.5"><GitFork size={12} /> {repo.forks}</span>
 </div>
 </div>
 </motion.a>
 ))}
 ...
 <span className="text-xs text-mutedText font-body">{stat.label}</span>
 <span className="text-xs text-white font-bold font-code">{stat.val}</span>
 </div>
 ))}
 </div>
 ...
 <div className="mt-8">
 <h4 className="text-xs text-white font-heading font-bold mb-3">Top Languages Used</h4>
 <div className="h-2 rounded-full overflow-hidden flex w-full">
 <div className="bg-blue-400 h-full" style={{ width: '45%' }} title="TypeScript (45%)" />
 <div className="bg-sky-400 h-full" style={{ width: '35%' }} title="JavaScript (35%)" />
 <div className="bg-emerald-400 h-full" style={{ width: '15%' }} title="CSS/HTML (15%)" />
 <div className="bg-yellow-500 h-full" style={{ width: '5%' }} title="Others (5%)" />
 </div>

 <div className="flex flex-wrap gap-x-4 gap-y-2 mt-4 text-[10px] font-code text-zinc-500">
 <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-blue-400" /> TS (45%)</span>
 <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-sky-400" /> JS (35%)</span>
 <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-emerald-400" /> CSS (15%)</span>
 <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-yellow-500" /> Others (5%)</span>
 </div>
 </div>
