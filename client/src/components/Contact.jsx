...
export default function Contact() {
 ...
 navigator.clipboard.writeText('abhishekh.kumar@example.com');
 setCopied(true);
 ...
 if (!response.ok) {
 throw new Error(data.error || (data.errors && data.errors[0]?.msg) || 'Failed to submit message.');
 }
 ...
 <div className="absolute bottom-0 right-0 w-[450px] h-[450px] rounded-full bg-secondary/5 blur-[130px] pointer-events-none" />
 ...
 >
 Submit an inquiry below or drop an email to discuss projects, collaborations, or job roles.
 </motion.p>
 </div>
 ...
 <h3 className="text-lg font-heading font-bold text-white mb-2">Let's build together</h3>
 <p className="text-xs sm:text-sm text-zinc-400 font-body leading-relaxed">
 I am available for freelance contracts, full-time engineering positions, or code consulting. Shoot me a message!
 </p>
 </div>
 ...
 <span>abhishekh.kumar@example.com</span>
 </div>
 <button
 ...
 >
 <h4 className="text-xs text-white font-heading font-bold uppercase tracking-wider mb-4">Networks</h4>
 <div className="flex gap-4">
 {[
 { icon: <FaGithub size={18} />, label: 'GitHub', href: 'https://github.com/abhishekh-developer' },
 { icon: <FaLinkedin size={18} />, label: 'LinkedIn', href: 'https://linkedin.com' },
 { icon: <FaXTwitter size={18} />, label: 'Twitter', href: 'https://twitter.com' }
 ].map((item, idx) => (
 <a
 key={idx}
 href={item.href}
 ...
 className="flex-grow flex items-center justify-center gap-2 py-2.5 bg-surface hover:bg-zinc-800 border border-white/5 hover:border-white/10 rounded-xl text-xs text-mutedText hover:text-white font-semibold transition-all"
 >
 {item.icon}
 ...
 <span>Your inquiry was logged successfully! Abhishekh will review this shortly.</span>
 </motion.div>
 )}
 ...
 <label htmlFor="name" className="text-xs font-semibold text-zinc-400 font-body">Name</label>
 <input
 type="text"
 id="name"
 name="name"
 ...
 <div className="space-y-1.5">
 <label htmlFor="email" className="text-xs font-semibold text-zinc-400 font-body">Email</label>
 <input
 type="email"
 id="email"
 name="email"
 ...
 <div className="space-y-1.5">
 <label htmlFor="subject" className="text-xs font-semibold text-zinc-400 font-body">Subject</label>
 <input
 type="text"
 id="subject"
 name="subject"
 ...
 <div className="space-y-1.5">
 <label htmlFor="message" className="text-xs font-semibold text-zinc-400 font-body">Message</label>
 <textarea
 id="message"
 name="message"
 rows={4}
