...
const fallbackExperiences = [
 ...
 {
 role: 'Undergraduate Project Lead',
...
export default function Experience() {
 ...
 >
 Tracing my experiences across college initiatives, engineering teams, and open source ecosystems.
 </motion.p>
 </div>
 ...
 {/* Main Card Wrapper */}
 <div className={`w-full md:w-1/2 pl-6 md:pl-0 ${isLeft ? 'md:pr-10' : 'md:pl-10'}`}>
 ...
 {/* Role & Company */}
 <h3 className="text-lg font-heading font-bold text-white leading-snug">{exp.role}</h3>
 <h4 className="text-sm font-body text-zinc-400 font-semibold mb-5">{exp.company}</h4>
