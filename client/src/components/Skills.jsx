...
import { Sparkles, Brain, Cpu, Database, Cloud, Settings, Terminal, Layers } from 'lucide-react';

// Hardcoded fallback list in case Redux is not populated yet
const fallbackSkills = [
 { name: 'React', category: 'Frontend', icon: 'React', currentlyLearning: false },
 { name: 'Next.js', category: 'Frontend', icon: 'Nextjs', currentlyLearning: false },
 { name: 'Tailwind CSS', category: 'Frontend', icon: 'Tailwind', currentlyLearning: false },
 { name: 'Redux Toolkit', category: 'Frontend', icon: 'Redux', currentlyLearning: false },
 { name: 'JavaScript', category: 'Frontend', icon: 'Javascript', currentlyLearning: false },
 { name: 'TypeScript', category: 'Frontend', icon: 'Typescript', currentlyLearning: false },
 { name: 'Framer Motion', category: 'Frontend', icon: 'Framer', currentlyLearning: false },
 { name: 'Node.js', category: 'Backend', icon: 'Nodejs', currentlyLearning: false },
 { name: 'Express', category: 'Backend', icon: 'Express', currentlyLearning: false },
 { name: 'REST APIs', category: 'Backend', icon: 'RestApi', currentlyLearning: false },
 { name: 'JWT', category: 'Backend', icon: 'Jwt', currentlyLearning: false },
 { name: 'MongoDB', category: 'Databases', icon: 'Mongodb', currentlyLearning: false },
 { name: 'PostgreSQL', category: 'Databases', icon: 'Postgres', currentlyLearning: false },
 { name: 'Redis', category: 'Databases', icon: 'Redis', currentlyLearning: false },
 { name: 'Firebase', category: 'Databases', icon: 'Firebase', currentlyLearning: false },
 { name: 'Docker', category: 'DevOps', icon: 'Docker', currentlyLearning: false },
 { name: 'GitHub Actions', category: 'DevOps', icon: 'GithubActions', currentlyLearning: false },
 { name: 'Vercel', category: 'DevOps', icon: 'Vercel', currentlyLearning: false },
 { name: 'Render', category: 'DevOps', icon: 'Render', currentlyLearning: false },
 { name: 'Git', category: 'Tools', icon: 'Git', currentlyLearning: false },
 { name: 'GitHub', category: 'Tools', icon: 'Github', currentlyLearning: false },
 { name: 'VS Code', category: 'Tools', icon: 'Vscode', currentlyLearning: false },
 { name: 'Postman', category: 'Tools', icon: 'Postman', currentlyLearning: false },
 { name: 'Figma', category: 'Tools', icon: 'Figma', currentlyLearning: false },
 { name: 'OpenAI API', category: 'AI', icon: 'Openai', currentlyLearning: false },
 { name: 'Gemini API', category: 'AI', icon: 'Gemini', currentlyLearning: false },
...
export default function Skills() {
 ...
 const categories = ['Frontend', 'Backend', 'Databases', 'DevOps', 'Tools', 'AI'];
 ...
 <div className="absolute top-1/2 left-0 w-[450px] h-[450px] rounded-full bg-secondary/5 blur-[130px] pointer-events-none -translate-y-1/2" />
 ...
 >
 A curated list of frameworks, database management engines, and cloud development practices I leverage.
 </motion.p>
 </div>
 ...
 <h3 className="font-heading font-bold text-base text-white">{category}</h3>
 </div>
 ...
 <div>
 <h3 className="font-heading font-bold text-base text-white">Currently Deep Diving</h3>
 <p className="text-xs text-mutedText mt-0.5">Exploring next-gen technologies to expand portfolio capabilities.</p>
 </div>
 </div>
