export const initialSkills = [
    ...
    { name: 'Next.js', category: 'Frontend', icon: 'Nextjs', currentlyLearning: true },
    ...
    { name: 'TypeScript', category: 'Frontend', icon: 'Typescript', currentlyLearning: true },
    ...
    { name: 'Redis', category: 'Databases', icon: 'Redis', currentlyLearning: true },
    // DevOps
...
export const initialExperiences = [
    ...
    },
    {
        ...
        technologies: ['JavaScript', 'HTML5', 'CSS3', 'Node.js', 'Mongodb'],
        achievements: [
...
export const initialAchievements = [
    {
        title: 'Smart India Hackathon Particaipant',
        category: 'Hackathons',
        value: '-',
        description: 'National level paticipant for presenting an innovative travel solution using geo-routing.',
    ...
    // },
    {
        ...
        description: 'Contributed performance patches, accessibility audits, and custom utility features to popular repositories.',
...
export const initialProjects = [
    ...
    //     tags: ['React', 'TypeScript', 'Node.js', 'Socket.io', 'MongoDB', 'Framer Motion'],
    //     features: [
    ...
    // },
    {
        ...
        liveUrl: 'weather-app-theta-two-15.vercel.app',
        featured: false,
