...
export const initialProjects = [
  ...
  },
  {
    ...
    description:
      "A full-stack job application tracking platform that helps users organize, manage, and monitor their job applications in one place. Users can track application status, company details, job roles, notes, deadlines, and reminders through a clean and responsive dashboard.",
    longDescription:
    ...
    features: [
      "User authentication, protected routes, and email verification",
